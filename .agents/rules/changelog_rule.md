...
As an AI assistant working on this project (`ai-orchestrator-project`), you MUST adhere to the following rule:
...
3. Obey the overarching project constraints, plan modes, and logging heuristics strictly defined within `CLAUDE.md`. Update `tasks/lessons.md` after correcting behavior.
