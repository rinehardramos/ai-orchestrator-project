...
3. Obey the overarching project constraints, plan modes, and logging heuristics strictly defined within `GEMINI.md`. Update `tasks/lessons.md` after correcting behavior.
